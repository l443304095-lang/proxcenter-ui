...
export default function SettingsPage() {
  ...
  const allTabs = [
    ...
    { label: 'LDAP / Active Directory', icon: 'ri-server-line', component: LdapConfigTab, providerOnly: true },
    { label: 'OIDC / SSO', icon: 'ri-shield-keyhole-line', component: OidcConfigTab, providerOnly: true },
